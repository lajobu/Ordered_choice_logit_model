...
Trying to combat the files weight limits, we have found out a work around with [Git Large File Storage](https://git-lfs.github.com/). This open source Git extension allows one to publish large files (LFS), with a **limit of 1GB of free storage and 1GB a month of free bandwidth**.
